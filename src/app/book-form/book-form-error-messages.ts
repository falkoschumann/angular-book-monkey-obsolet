...
export const BookFormErrorMessages = [
  ...
  new ErrorMessage('isbn', 'isbnFormat', 'Die ISBN muss 10 oder 13 Zeichen bestehen.'),
  new ErrorMessage('isbn', 'isbnExists', 'Die ISBN existiert bereits.'),
  new ErrorMessage('published', 'required', 'Es muss ein Erscheindungsdatum angegeben werden.'),
